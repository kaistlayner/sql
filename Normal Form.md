...
테이블 T의 임의의 속성(attribute) (a, b, c)가 존재할 때, (a, b), (b, c), (a, c)에 대해 테이블 T를 projection한 테이블 Tab, Tbc, Tac를 조인한 **Tab JOIN Tbc JOIN Tac**의 결과가 T와 같을 때 PJNF이라고 한다. (정보 손실 없이 더 이상 분해가 불가능)
# 여담
